...
class CategoriasSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('categorias')->insert([
            ...
            ['nombre' => 'Tequila', 'parent_id' => $ids['Licores y destilados'], 'created_at' => now(), 'updated_at' => now()],
            ['nombre' => 'Ron', 'parent_id' => $ids['Licores y destilados'], 'created_at' => now(), 'updated_at' => now()],
            ['nombre' => 'Whisky', 'parent_id' => $ids['Licores y destilados'], 'created_at' => now(), 'updated_at' => now()],
            ['nombre' => 'Vodka', 'parent_id' => $ids['Licores y destilados'], 'created_at' => now(), 'updated_at' => now()],
            ['nombre' => 'Ginebra', 'parent_id' => $ids['Licores y destilados'], 'created_at' => now(), 'updated_at' => now()],
            ['nombre' => 'Mezcal', 'parent_id' => $ids['Licores y destilados'], 'created_at' => now(), 'updated_at' => now()],
            ['nombre' => 'Cremas y licores', 'parent_id' => $ids['Licores y destilados'], 'created_at' => now(), 'updated_at' => now()],
            ['nombre' => 'Cognac', 'parent_id' => $ids['Licores y destilados'], 'created_at' => now(), 'updated_at' => now()],
            ['nombre' => 'Brandy', 'parent_id' => $ids['Licores y destilados'], 'created_at' => now(), 'updated_at' => now()],
            ['nombre' => 'Sake', 'parent_id' => $ids['Licores y destilados'], 'created_at' => now(), 'updated_at' => now()],
            ['nombre' => 'Otros destilados', 'parent_id' => $ids['Licores y destilados'], 'created_at' => now(), 'updated_at' => now()],
